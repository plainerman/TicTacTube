...
namespace TicTacTubeCore.Utils.Extensions.Strings
{
	...
	{
		/// <summary>
		///     This method works similar to <see cref="Regex.Split(string)" /> only that it is capable of splitting on multiple
		...
		public static string[] SplitMulti(string input, string[] patterns) => SplitMulti(input, patterns,
			ArrayUtils.Multiplex(RegexOptions.None, patterns.Length), out _);
		...
		public static string[] SplitMulti(string input, string[] patterns, out IList<StringPosition> foundSplits) =>
			SplitMulti(input, patterns, ArrayUtils.Multiplex(RegexOptions.None, patterns.Length), out foundSplits);
		...
		public static string[] SplitMulti(string input, string[] patterns, RegexOptions[] options,
			out IList<StringPosition> foundSplits) => SplitMulti(input, patterns, options,
			ArrayUtils.Multiplex(Timeout.InfiniteTimeSpan, patterns.Length), out foundSplits);
